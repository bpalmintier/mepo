...
RUN_CODE="TX07_yr_x0_2_rps20_rsrv_uc2"
...
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS}  ${LONG_OPTS} --rsrv=flex --unit_commit=1"
