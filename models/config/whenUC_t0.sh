...
RUN_CODE="whenUC_0_TX07_yr_c80_rps20_full_maint"
...
RUN_OPT=" --rps=0.2 --co2cost=80 --rsrv=separate --startup=1 --min_up_down=1 --ramp=1 --maint=1 --demand=ercot2007_dem_yr.inc"
...
RUN_CODE="whenUC_0_TX07_yr_c80_rps20_simp_maint"
...
# Setup run specific OPT
RUN_OPT=" --rps=0.2 --co2cost=80 --maint=1 --demand=ercot2007_dem_yr.inc "
