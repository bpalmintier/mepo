...
#----------------------------
ID_CODE="50GWadp"
MATLAB_COMMAND="[SpResults${ID_CODE}, SpParams${ID_CODE}, SpValues${ID_CODE}, SpBuild${ID_CODE}, OpsCache${ID_CODE}]=RunSimsFutureLowCO2(2,[],''UnitCommit'',[],50000, [],[],[],''adp'',50,500)"
COMMAND_FOR_FILENAME="RunSimsFutureLowCO2_07_${ID_CODE}"
