...
COMMON_OPTIONS=" -errmsg=1  -lo=2  -inputdir=${MODEL_DIR} --out_dir=${OUT_DIR} --no_nse=1 --sys=mftest_sys.inc --gens=gens_all_new.inc --rps=0.2 --co2cost=80 --demscale=0.2 --min_gen_size=0.2 --update=../data/TX07_yr_x0_2_rps20_c80_update.inc "

LONG_OPTS=" --par_threads=6 --lp_method=6 --max_solve_time=111000 --par_mode=-1 --probe=2 "

#======= Everything Except U/D time =======
RUN_CODE="TX07_yr_x0_2_rps20_rsrv_ramp_start"
...
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS}  ${LONG_OPTS}  --rsrv=flex --startup=1 --ramp=1"
...
#======= Everything Except Startup Cost =======
RUN_CODE="TX07_yr_x0_2_rps20_rsrv_ramp_ud"
...
# Setup run specific options
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS}  ${LONG_OPTS}  --min_up_down=1 --rsrv=flex --startup=1 --ramp=1"
...
#======= Everything Except U/D time UCLP =======
RUN_CODE="TX07_yr_x0_2_rps20_uclp_rsrv_ramp_start"
...
# Setup run specific options
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS} --rsrv=flex --startup=1 --ramp=1 --no_int_uc=1 "
...
#======= Everything Except Startup Cost UCLP =======
RUN_CODE="TX07_yr_x0_2_rps20_uclp_rsrv_ramp_ud"
...
# Setup run specific options
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS} --min_up_down=1 --rsrv=flex --startup=1 --ramp=1 --no_int_uc=1 "
