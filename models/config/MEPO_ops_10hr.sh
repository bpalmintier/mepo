...
#  - Setups full week for max SOLVE time of 10hrs with 24hr walltime from queue
#  - Uses older Nehalem cluster nodes for better backward comparison
#
# Notes:
...
# ---  ----------  ----- -------------- ---------------------------------
#   1  2013-10-14  10:35  bpalmintier   Adapted from MEPO_ops_168hr.sh v1
