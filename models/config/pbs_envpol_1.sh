...
COMMAND_FOR_FILENAME="EnvPolicyScenarios_r05_4gw_freeBuild_SimpOps"
...
MATLAB_COMMAND="RunSaveExit('SpResults_r05_4gw_freeBuild_SimpOps = RunEnvPolicyScenarios([1:7,12], [], [], 0.05, 4000, true)','${RESULT_FILE}.mat')"
