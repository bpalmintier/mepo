...
#
# IMPORTANT: If your runs do not have exclusive machine use (ie you have more
# than one run on the same machine), you must comment out the line that deletes
# /scratch/${USER}/ before the run or you can interfere with the other job
#
# To actually submit the job use:
#   qsub SCRIPT_NAME
#
# NOTE: This is a BASH script, The magic "#!..." line above will cause this
# script to be run using bash (Bourne Again SHell) when you submit it to the
...
#   2  2012-04-23  11:55  bpalmintier   Expanded comments
...
# Show free & used harddisk space on all of the machine's drives
echo "Disk usage:"
df -h
