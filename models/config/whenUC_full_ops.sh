#!/bin/bash
#
# Thesis Ch4: OPS RUNS for When does UC matter Grid ARRAY 
...
# ---  ----------  ----- -------------- ---------------------------------
#   1  2012-09-01  16:20  bpalmintier   Adapted from whenUC_full.sh v4
#   2  2012-09-01  16:20  bpalmintier   Converted to ops runs based on CpUc_co2_pol_ops.sh v2
...
source ${CONFIG_DIR}/whenUC_opsrun.sh `sed -n "${PBS_ARRAYID} s/[,	]/ /gp" < ${CONFIG_DIR}/whenUC_full_list.csv`
