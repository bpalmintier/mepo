...
#   ERCOT 2007, from scratch (100% retire), min 200MW gen, 20% RPS, $80 CO2, USE Cap limit "helper"
...
#   2  2012-08-21  23:45  bpalmintier   Convert to from scratch 100% retire
...
THIS_FILE_OPT="${ALL_RUN_OPT} --retire=1.0 --rps=0.2 --co2cost=80 --demand=ercot2007_dem_yr_as_14wk.inc "
...
RUN_CODE="whenUC_t8_y14wk_c80_rps20_full_mnt_rt1_maxst"
...
#======= 14wk Full Ops w/ Maintenance & Combined Reserves =======
RUN_CODE="whenUC_t8_y14wk_c80_rps20_flex_mnt_rt1"
...
RUN_CODE="whenUC_t8_y14wk_c80_rps20_full_mnt_rt1_u008"
...
#======= 14wk Full Ops w/ Maintenance 200MW min UC integer =======
RUN_CODE="whenUC_t8_y14wk_c80_rps20_full_mnt_rt1_u02"
...
RUN_CODE="whenUC_t8_y14wk_c80_rps20_flex_mnt_rt1_u008"
