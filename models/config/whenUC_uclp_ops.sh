...
# ---  ----------  ----- -------------- ---------------------------------
#   1  2012-09-06  07:40  bpalmintier   Adapted from whenUC_simp_ops.sh v2
...
source ${CONFIG_DIR}/whenUC_opsrun.sh `sed -n "${PBS_ARRAYID} s/[,	]/ /gp" < ${CONFIG_DIR}/whenUC_uclp_list.csv`
