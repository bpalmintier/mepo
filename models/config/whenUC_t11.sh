...
#     -- 50% retire, B&B priority, No cheat, No cap limit helper
...
#     -- From scratch, B&B priority, No cheat, No cap limit helper
...
# ---  ----------  ----- -------------- ---------------------------------
#   1  2012-08-21  23:42  bpalmintier   Adapted from whenUC_t9.sh v2
#   2  2012-08-21  23:45  bpalmintier   Added additional test cases (b/c of uc_int_unit_min bugfix)
...
#======= 50% retire, B&B priority, No cheat, USE cap limit helper =======
RUN_CODE="whenUC_t11_y14wk_c80_rps20_flex_rt05_u008_pri_clim"
...
RUN_OPT=" --retire=0.5 --priority=on "
...
#======= 50% retire, B&B priority, No cheat, No cap limit helper =======
RUN_CODE="whenUC_t11_y14wk_c80_rps20_flex_rt05_u008_pri"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT=" --retire=0.5 --priority=on --skip_cap_limit=1 "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
#======= 50% retire, No B&B priority, No cheat, No cap limit helper =======
RUN_CODE="whenUC_t11_y14wk_c80_rps20_flex_rt05_u008"
...
#======= 50% retire, B&B priority, No cheat, USE cap limit helper =======
RUN_CODE="whenUC_t11_y14wk_c80_rps20_flex_rt05_u008_clim"
...
#======= From scratch, B&B priority, No cheat, USE cap limit helper =======
RUN_CODE="whenUC_t11_y14wk_c80_rps20_flex_rt1_u008_pri_clim"
...
#======= From scratch, B&B priority, No cheat, No cap limit helper =======
RUN_CODE="whenUC_t11_y14wk_c80_rps20_flex_rt1_u008_pri"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT=" --retire=1 --priority=on --skip_cap_limit=1 "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
#======= From Scratch, B&B priority, 0.1% relcheat, USE cap limit helper =======
RUN_CODE="whenUC_t11_y14wk_c80_rps20_flex_rt1_u008_pri_ch01_clim"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT=" --retire=1 --priority=on --rel_cheat=0.001"
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
#======= From Scratch, B&B priority, 0.1% relcheat, No cap limit helper =======
RUN_CODE="whenUC_t11_y14wk_c80_rps20_flex_rt1_u008_pri_ch01"
...
#======= From Scratch, No B&B priority, No cheat, No cap limit helper =======
RUN_CODE="whenUC_t11_y14wk_c80_rps20_flex_rt1_u008"
...
#======= From scratch, No B&B priority, No cheat, USE cap limit helper =======
RUN_CODE="whenUC_t11_y14wk_c80_rps20_flex_rt1_u008_clim"
...
#======= From Scratch, No B&B priority, 0.1% relcheat, No cap limit helper =======
RUN_CODE="whenUC_t11_y14wk_c80_rps20_flex_rt1_u008_ch01"
...
#======= From scratch, No B&B priority, 0.1% relcheat, USE cap limit helper =======
RUN_CODE="whenUC_t11_y14wk_c80_rps20_flex_rt1_u008_clim_ch01"
