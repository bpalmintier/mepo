...
LONG_OPTS=" --par_threads=4 --lp_method=6 --max_solve_time=36000 "

#======= Simple Ops =======
RUN_CODE="TX07_yr_x0_2_rps20_simple"
...
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS}"
...
#======= Rsrv Ops =======
RUN_CODE="TX07_yr_x0_2_rps20_rsrv"
...
# Setup run specific options
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS} ${LONG_OPTS}  --rsrv=flex"
