...
COMMAND_FOR_FILENAME="EnvPolicyScenarios_r20_OpsLp"
MATLAB_COMMAND="RunSaveExit('[SpSummary, ~, SpValues, SpBuild, OpsCache] = RunEnvPolicyScenarios(7, ''../data/EnvPolScen_OpsCache.mat'', ''OpsLp'', 0.20, 2000, true)','${COMMAND_FOR_FILENAME}_${PBS_JOBID}')"
