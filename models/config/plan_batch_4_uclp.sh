...
COMMON_OPTIONS=" -errmsg=1  -lo=2  -inputdir=${MODEL_DIR} --out_dir=${OUT_DIR} --no_nse=1 --sys=mftest_sys.inc --gens=gens_all_new.inc --rps=0.2 --co2cost=80 --demscale=0.2 --no_int_uc=1 "

LONG_OPTS=" --max_solve_time=36000 "

#======= Full Ops (LP) =======
RUN_CODE="TX07_yr_x0_2_rps20_uclp_rsv_rmp_st_ud"
...
#======= Ramp + UC(minout) Ops (LP) =======
RUN_CODE="TX07_yr_x0_2_rps20_uclp_ramp_uc"
...
# Setup run specific options
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS} ${LONG_OPTS} --ramp=1 --unit_commit=1"
...
#======= Start-only (UC) Ops (LP) =======
RUN_CODE="TX07_yr_x0_2_rps20_uclp_start"
...
# Setup run specific options
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS} ${LONG_OPTS}   --startup=1"
...
#======= Up/down constraints only Ops (LP) =======
RUN_CODE="TX07_yr_x0_2_rps20_uclp_ud"
...
# Setup run specific options
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS}  ${LONG_OPTS}  --min_up_down=1"
...
#======= Reserves with UC Ops (LP) =======
RUN_CODE="TX07_yr_x0_2_rps20_uclp_rsrv_uc"
...
# Setup run specific options
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS} --rsrv=flex --unit_commit=1"
...
#======= Ramp + Reserves UC(minout) Ops (LP) =======
RUN_CODE="TX07_yr_x0_2_rps20_uclp_rsrv_ramp_uc"
...
# Setup run specific options
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS} ${LONG_OPTS} --ramp=1 --unit_commit=1 --rsrv=flex"
...
#======= Minout-only (UC) Ops (LP) =======
RUN_CODE="TX07_yr_x0_2_rps20_uclp_uc"
...
#======= Max Startup (UC) Ops (LP) =======
RUN_CODE="TX07_yr_x0_2_rps20_uclp_maxstart"
...
# Setup run specific options
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS}  ${LONG_OPTS}  --max_start=1 --startup=1"
