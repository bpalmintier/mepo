...
RUN_CODE="RTS_x1_wk_sep_ud_m0_Plist"
...
GAMS_OPTIONS="-errmsg=1 -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -lo=2 -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst -inputdir=${MODEL_DIR} --out_dir=${OUT_DIR} --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_run_time_compare_v${ADVPOWER_REPO_VER}_${DATE_TIME}     --no_nse=1 --par_threads=1 --startup=1 --ramp=1 --out_gen_params=1 --max_solve_time=36000 --sys=ieee_rts96_sys.inc --gens=ieee_rts96_gens_sepunit.inc --demand=ieee_rts96_dem_wk.inc --demscale=0.92 --min_up_down=1 --rsrv=separate --pwl_cost=1 --mip_gap=0  --update=../data/sepunit_priority_list_update.inc "
...
RUN_CODE="RTS_x1_wk_sep_ud_ch010_m0_Plist"
...
#
# Plus additional user supplied options pasted into template
GAMS_OPTIONS="-errmsg=1 -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -lo=2 -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst -inputdir=${MODEL_DIR} --out_dir=${OUT_DIR} --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_run_time_compare_v${ADVPOWER_REPO_VER}_${DATE_TIME}     --no_nse=1 --par_threads=1 --startup=1 --ramp=1 --out_gen_params=1 --max_solve_time=36000 --sys=ieee_rts96_sys.inc --gens=ieee_rts96_gens_sepunit.inc --demand=ieee_rts96_dem_wk.inc --demscale=0.92 --min_up_down=1 --rsrv=separate --pwl_cost=1 --rel_cheat=0.001 --mip_gap=0  --update=../data/sepunit_priority_list_update.inc "
...
RUN_CODE="RTS_x1_wk_sep_ud_m01_Plist"
...
#
# Plus additional user supplied options pasted into template
GAMS_OPTIONS="-errmsg=1 -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -lo=2 -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst -inputdir=${MODEL_DIR} --out_dir=${OUT_DIR} --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_run_time_compare_v${ADVPOWER_REPO_VER}_${DATE_TIME}     --no_nse=1 --par_threads=1 --startup=1 --ramp=1 --out_gen_params=1 --max_solve_time=36000 --sys=ieee_rts96_sys.inc --gens=ieee_rts96_gens_sepunit.inc --demand=ieee_rts96_dem_wk.inc --demscale=0.92 --min_up_down=1 --rsrv=separate --pwl_cost=1 --mip_gap=0.001  --update=../data/sepunit_priority_list_update.inc "
...
RUN_CODE="RTS_x1_wk_sep_ud_ch010_m01_Plist"
