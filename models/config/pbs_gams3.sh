...
GAMS_OPTIONS="-errmsg=1 --out_dir=${OUT_DIR}  -lf=${OUT_DIR}${GAMS_MODEL}.log -lo=2 -o=${OUT_DIR}${GAMS_MODEL}.lst --sys=ercot2009_sys.inc  --update=../data/ieee2011_update.inc --ramp=1 --unit_commit=1 --startup=1 --no_nse=1 --max_start=1 --max_solve_time=25000 --par_threads=12  --uc_ignore_unit_min=20 --flex_rsrv=1 --co2cost=75 --memo=UC_ops_cap_plan_c40_shed_v${ADVPOWER_REPO_VER}_${DATE_TIME}"
