...
RUN_CODE="TX07_yr_x0_2_rps20_rsrv_start_ud"
...
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS}  ${LONG_OPTS}  --rsrv=flex --startup=1 --min_up_down=1 "
...
#======= Everything Except Ramp UCLP =======
RUN_CODE="TX07_yr_x0_2_rps20_uclp_rsrv_start_ud"
...
# Setup run specific options
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS} --rsrv=flex --startup=1 --min_up_down=1 --no_int_uc=1 "
