...
RUN_CODE="whenUC_simp_cmx94_r40"
...
RUN_OPT="   --max_solve_time=216000 --co2cap=94 --rps=0.4 --maint=1 --derate=1 --plan_margin=on  "
...
RUN_CODE="whenUC_edRsv_cmx94_r40_sep"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT="   --max_solve_time=216000 --uc_ignore_unit_min=Inf --co2cap=94 --rps=0.4 --maint=1 --rsrv=separate --plan_margin=0.05  "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
RUN_CODE="whenUC_uclp_cmx94_r40_sep"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT="   --max_solve_time=216000 --uc_int_unit_min=Inf --co2cap=94 --rps=0.4 --maint=1 --rsrv=separate --ramp=1 --unit_commit=1 --startup=1 --min_up_down=1 --plan_margin=0.05  "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
RUN_CODE="whenUC_full_int60_cmx94_r40_sep"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT="   --max_solve_time=216000 --uc_int_unit_min=0.06 --co2cap=94 --rps=0.4 --maint=1 --rsrv=separate --ramp=1 --unit_commit=1 --startup=1 --min_up_down=1 --plan_margin=0.05  "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
RUN_CODE="whenUC_simp_cmx94_r60"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT="   --max_solve_time=216000 --co2cap=94 --rps=0.6 --maint=1 --derate=1 --plan_margin=on  "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
RUN_CODE="whenUC_edRsv_cmx94_r60_sep"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT="   --max_solve_time=216000 --uc_ignore_unit_min=Inf --co2cap=94 --rps=0.6 --maint=1 --rsrv=separate --plan_margin=0.05  "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
RUN_CODE="whenUC_uclp_cmx94_r60_sep"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT="   --max_solve_time=216000 --uc_int_unit_min=Inf --co2cap=94 --rps=0.6 --maint=1 --rsrv=separate --ramp=1 --unit_commit=1 --startup=1 --min_up_down=1 --plan_margin=0.05  "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
RUN_CODE="whenUC_full_int60_cmx94_r60_sep"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT="   --max_solve_time=216000 --uc_int_unit_min=0.06 --co2cap=94 --rps=0.6 --maint=1 --rsrv=separate --ramp=1 --unit_commit=1 --startup=1 --min_up_down=1 --plan_margin=0.05  "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
RUN_CODE="whenUC_simp_cmx94_r80"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT="   --max_solve_time=216000 --co2cap=94 --rps=0.8 --maint=1 --derate=1 --plan_margin=on  "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
RUN_CODE="whenUC_edRsv_cmx94_r80_sep"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT="   --max_solve_time=216000 --uc_ignore_unit_min=Inf --co2cap=94 --rps=0.8 --maint=1 --rsrv=separate --plan_margin=0.05  "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
RUN_CODE="whenUC_uclp_cmx94_r80_sep"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT="   --max_solve_time=216000 --uc_int_unit_min=Inf --co2cap=94 --rps=0.8 --maint=1 --rsrv=separate --ramp=1 --unit_commit=1 --startup=1 --min_up_down=1 --plan_margin=0.05  "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
RUN_CODE="whenUC_full_int60_cmx94_r80_sep"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT="   --max_solve_time=216000 --uc_int_unit_min=0.06 --co2cap=94 --rps=0.8 --maint=1 --rsrv=separate --ramp=1 --unit_commit=1 --startup=1 --min_up_down=1 --plan_margin=0.05  "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
