#!/bin/bash
#
# Thesis Ch4: When does UC matter Business as Usual baseline for CO2
...
#     -- Full MILP solution, 80MW min UC integer, non-parallel
#     -- UCLP: Ignore all UC integer (Inf min) (MILP for maintenance & investments)
#	  -- RMILP: ignore all integers
#     -- Parallel (4-core): Full MILP solution, 80MW min UC integer
#
...
# ---  ----------  ----- -------------- ---------------------------------
#   1  2012-08-23  12:20  bpalmintier   Adapted from whenUC_t9.sh v2 (whenUC_base v4)
#   2  2012-08-23  12:20  bpalmintier   Added business as usual
...
THIS_FILE_OPT="${ALL_RUN_OPT} --retire=1 --demand=ercot2007_dem_yr_as_14wk.inc --maint=1 --plan_margin=0.05 --rsrv=flex --startup=1 --unit_commit=1 --ramp=1 --min_up_down=1 "
...
#======= Full MILP solution, 80MW min UC integer, non-parallel =======
RUN_CODE="whenUC_bau_y14wk_c0_rps0_flex_rt1_u008"
...
#======= UCLP: Ignore all UC integer (Inf min) (MILP for maintenance & investments) =======
RUN_CODE="whenUC_bau_y14wk_c0_rps0_flex_rt1_u008_uclp"
...
#======= RMILP: ignore all integers =======
RUN_CODE="whenUC_bau_y14wk_c0_rps0_flex_rt1_u008_rmilp"
...
#======= Parallel (4-core): Full MILP solution, 80MW min UC integer =======
RUN_CODE="whenUC_bau_y14wk_c0_rps0_flex_rt1_u008_par4"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT=" --uc_int_unit_min=0.08 ${PAR_OPT} "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
