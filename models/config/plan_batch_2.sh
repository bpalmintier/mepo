...
COMMON_OPTIONS=" -errmsg=1  -lo=2  -inputdir=${MODEL_DIR} --out_dir=${OUT_DIR} --no_nse=1 --sys=mftest_sys.inc --gens=gens_all_new.inc --rps=0.2 --co2cost=80 --demscale=0.2"

LONG_OPTS=" --par_threads=2 --lp_method=6 --max_solve_time=36000 "

#======= Ramp-only Ops =======
RUN_CODE="TX07_yr_x0_2_rps20_ramp"
...
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS} --ramp=1"
...
#======= Ramp + UC(minout) Ops =======
RUN_CODE="TX07_yr_x0_2_rps20_ramp_uc"
...
#======= Start-only (UC) Ops =======
RUN_CODE="TX07_yr_x0_2_rps20_start"
...
#======= Up/down constraints only =======
RUN_CODE="TX07_yr_x0_2_rps20_ud"
