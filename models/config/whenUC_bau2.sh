#!/bin/bash
#
# Thesis Ch4: When does UC matter Business as Usual baseline for CO2 (2nd set)
#   ERCOT 2007, min 200MW gen, 0% RPS, $0 CO2, Year as 52 weeks
#   Full Ops w/ Maintenance
#   No B&B priority, No cheat, No cap limit helper
#     -- From scratch: 80MW min UC integer, Flex reserves, non-parallel
#     -- From scratch: 80MW min UC integer, Sep reserves, non-parallel
#     -- From scratch: No min UC integer, Flex reserves, non-parallel
#     -- From scratch: No min UC integer, Sep reserves, non-parallel
#     -- 50% retire: 80MW min UC integer, Flex reserves, non-parallel
#     -- 50% retire: 80MW min UC integer, Sep reserves, non-parallel
#     -- Parallel (3-core): From scratch: 80MW min UC integer, Sep reserves
#     -- Parallel (3-core): 50% retire: 80MW min UC integer, Flex reserves
#
...
THIS_FILE_OPT="${ALL_RUN_OPT}  --demand=ercot2007_dem_yr_as_52wk.inc --maint=1 --plan_margin=0.05 --startup=1 --unit_commit=1 --ramp=1 --min_up_down=1 "
...
#======= From scratch: 80MW min UC integer, Flex reserves, non-parallel =======
RUN_CODE="whenUC_bau2_y52wk_c0_rps0_flex_rt1_u008"
...
RUN_OPT=" --retire=1 --uc_int_unit_min=0.08 --rsrv=flex "
...
#======= From scratch: 80MW min UC integer, Sep reserves, non-parallel =======
RUN_CODE="whenUC_bau2_y52wk_c0_rps0_sep_rt1_u008"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT=" --retire=1 --uc_int_unit_min=0.08 --rsrv=separate "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
#======= From scratch: No min UC integer, Flex reserves, non-parallel =======
RUN_CODE="whenUC_bau2_y52wk_c0_rps0_flex_rt1"
...
#======= From scratch: No min UC integer, Sep reserves, non-parallel =======
RUN_CODE="whenUC_bau2_y52wk_c0_rps0_sep_rt1"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT=" --retire=1 --rsrv=separate "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
#======= 50% retire: 80MW min UC integer, Flex reserves, non-parallel =======
RUN_CODE="whenUC_bau2_y52wk_c0_rps0_flex_rt05_u008"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT=" --retire=0.5 --uc_int_unit_min=0.08 --rsrv=flex "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
#======= 50% retire: 80MW min UC integer, Sep reserves, non-parallel =======
RUN_CODE="whenUC_bau2_y52wk_c0_rps0_sep_rt05_u008"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT=" --retire=0.5 --uc_int_unit_min=0.08 --rsrv=separate "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
#======= Parallel (3-core): From scratch: 80MW min UC integer, Sep reserves =======
RUN_CODE="whenUC_bau2_y52wk_c0_rps0_sep_rt1_u008_par"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT=" --retire=1 --uc_int_unit_min=0.08 --rsrv=separate ${PAR_OPT} "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
#======= Parallel (3-core): 50% retire: 80MW min UC integer, Flex reserves =======
RUN_CODE="whenUC_bau2_y52wk_c0_rps0_flex_rt05_u008_par"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT=" --retire=0.5 --uc_int_unit_min=0.08 --rsrv=flex ${PAR_OPT} "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
