...
# ---  ----------  ----- -------------- ---------------------------------
#   1  2012-09-04   9:27  bpalmintier   Adapted from whenUC_simp_ops.sh v2
#   2  2012-09-06  20:27  bpalmintier   Update range to run offline non-UC reserves set
...
source ${CONFIG_DIR}/whenUC_opsrun.sh `sed -n "${PBS_ARRAYID} s/[,	]/ /gp" < ${CONFIG_DIR}/whenUC_edRsv_list.csv`
