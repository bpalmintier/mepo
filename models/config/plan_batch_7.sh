...
LONG_OPTS=" --par_threads=8 --lp_method=6 --max_solve_time=111000 --par_mode=-1 --probe=2 "

#======= Everything Except Reserves =======
RUN_CODE="TX07_yr_x0_2_rps20_ramp_start_ud"
...
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS}  ${LONG_OPTS}  --startup=1 --min_up_down=1 --ramp=1 "
...
#======= Everything Except Reserves UCLP =======
RUN_CODE="TX07_yr_x0_2_rps20_uclp_ramp_start_ud"
...
# Setup run specific options
GAMS_OPTIONS=" -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst ${COMMON_OPTIONS} --startup=1 --min_up_down=1 --ramp=1  --no_int_uc=1 "
