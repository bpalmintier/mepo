...
#   ERCOT 2007, existing gens, min 200MW gen
#     -- 20% RPS, $80 CO2, Full UC + Maint, Full Year
#     -- 20% RPS, $80 CO2, Simple Ops + Maint, Full Year
#
...
THIS_FILE_OPT="${ALL_RUN_OPT} --rps=0.2 --co2cost=80 --demand=ercot2007_dem_yr.inc --maint=1 --skip_cap_limit=1 "
...
RUN_CODE="whenUC_t4_yr_c80_rps20_full_maint"
...
RUN_OPT=" --plan_margin=0.05 --rsrv=separate --startup=1 --unit_commit=1 --ramp=1 --min_up_down=1 "
...
RUN_CODE="whenUC_t4_yr_c80_rps20_simp_maint"
