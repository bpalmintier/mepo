...
#   ERCOT 2007, existing gens, min 200MW gen, 20% RPS, $80 CO2, USE Cap limit "helper"
...
# ---  ----------  ----- -------------- ---------------------------------
#   1  2012-08-18  01:20  bpalmintier   Adapted from whenUC_t5.sh v1
#   2  2012-08-21  23:00  bpalmintier   -- Updated to whenUC_base v3 (force rps, remove rps_penalty)
#										-- Use max unit helper (faster from t4 runs)
#										-- Corrected :80MW (vs 80*Giga*W) min UC
#   									-- New cases 200MW min & 80MW min w/ Combined
...
#   5  2012-08-25  09:25  bpalmintier   Correct renew_to_rps to match StaticCapPlan v82. It was & still is disabled.
...
RUN_CODE="whenUC_t6_y14wk_c80_rps20_full_mnt_maxst"
...
#======= 14wk Full Ops w/ Maintenance & Combined Reserves =======
RUN_CODE="whenUC_t6_y14wk_c80_rps20_flex_mnt"
...
RUN_CODE="whenUC_t6_y14wk_c80_rps20_full_mnt_u008"
...
#======= 14wk Full Ops w/ Maintenance 200MW min UC integer =======
RUN_CODE="whenUC_t6_y14wk_c80_rps20_full_mnt_u02"
...
RUN_CODE="whenUC_t6_y14wk_c80_rps20_flex_mnt_u008"
