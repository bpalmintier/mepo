...
COMMAND_FOR_FILENAME="EnvPolicyScenarios_r20_Dispatch"
MATLAB_COMMAND="RunSaveExit('[SpSummary, ~, SpValues, SpBuild, OpsCache] = RunEnvPolicyScenarios(5:6, [], [], 0.20, 2000, true)','${COMMAND_FOR_FILENAME}_${PBS_JOBID}')"
