...
RUN_CODE="RTS_x3_wk_sep_ud_comRsv_m01"
...
GAMS_OPTIONS="-errmsg=1 -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -lo=2 -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst -inputdir=${MODEL_DIR} --out_dir=${OUT_DIR} --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_run_time_compare_v${ADVPOWER_REPO_VER}_${DATE_TIME}     --no_nse=1 --par_threads=1 --startup=1 --ramp=1 --out_gen_params=1 --max_solve_time=36000 --sys=ieee_rts96_sys.inc --gens=ieee_rts96_gens_sepunit_x3.inc --demand=ieee_rts96_dem_wk.inc --demscale=2.76 --min_up_down=1 --rsrv=flex --pwl_cost=1 --mip_gap=0.001 "
...
RUN_CODE="RTS_x3_wk_clust_ud_m01_maxS"
...
#
# Plus additional user supplied options pasted into template
GAMS_OPTIONS="-errmsg=1 -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -lo=2 -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst -inputdir=${MODEL_DIR} --out_dir=${OUT_DIR} --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_run_time_compare_v${ADVPOWER_REPO_VER}_${DATE_TIME}     --no_nse=1 --par_threads=1 --startup=1 --ramp=1 --out_gen_params=1 --max_solve_time=36000 --sys=ieee_rts96_sys.inc --gens=ieee_rts96_gens_x3.inc --demand=ieee_rts96_dem_wk.inc --demscale=2.76 --min_up_down=1 --rsrv=separate --pwl_cost=1 --mip_gap=0.001  --max_start=1 "
...
RUN_CODE="RTS_x3_wk_sep_ud_m01_maxS"
...
#
# Plus additional user supplied options pasted into template
GAMS_OPTIONS="-errmsg=1 -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -lo=2 -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst -inputdir=${MODEL_DIR} --out_dir=${OUT_DIR} --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_run_time_compare_v${ADVPOWER_REPO_VER}_${DATE_TIME}     --no_nse=1 --par_threads=1 --startup=1 --ramp=1 --out_gen_params=1 --max_solve_time=36000 --sys=ieee_rts96_sys.inc --gens=ieee_rts96_gens_sepunit_x3.inc --demand=ieee_rts96_dem_wk.inc --demscale=2.76 --min_up_down=1 --rsrv=separate --pwl_cost=1 --mip_gap=0.001  --max_start=1 "
...
RUN_CODE="RTS_x3_wk_clust_NOminUD_m01"
...
#
# Plus additional user supplied options pasted into template
GAMS_OPTIONS="-errmsg=1 -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -lo=2 -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst -inputdir=${MODEL_DIR} --out_dir=${OUT_DIR} --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_run_time_compare_v${ADVPOWER_REPO_VER}_${DATE_TIME}     --no_nse=1 --par_threads=1 --startup=1 --ramp=1 --out_gen_params=1 --max_solve_time=36000 --sys=ieee_rts96_sys.inc --gens=ieee_rts96_gens_x3.inc --demand=ieee_rts96_dem_wk.inc --demscale=2.76 --rsrv=separate --pwl_cost=1 --mip_gap=0.001 "
...
RUN_CODE="RTS_x3_wk_sep_NOminUD_m01"
...
#
# Plus additional user supplied options pasted into template
GAMS_OPTIONS="-errmsg=1 -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -lo=2 -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst -inputdir=${MODEL_DIR} --out_dir=${OUT_DIR} --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_run_time_compare_v${ADVPOWER_REPO_VER}_${DATE_TIME}     --no_nse=1 --par_threads=1 --startup=1 --ramp=1 --out_gen_params=1 --max_solve_time=36000 --sys=ieee_rts96_sys.inc --gens=ieee_rts96_gens_sepunit_x3.inc --demand=ieee_rts96_dem_wk.inc --demscale=2.76 --rsrv=separate --pwl_cost=1 --mip_gap=0.001 "
