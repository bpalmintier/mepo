...
COMMAND_FOR_FILENAME="EnvPolicyScenarios_r05_4gw_RsrvOps"
MATLAB_COMMAND="RunSaveExit('[SpSummary, SpParams, SpValues, SpBuild, OpsCache] = RunEnvPolicyScenarios(1:7, [], ''OpsLp'', 0.05, 4000, true)','${COMMAND_FOR_FILENAME}_${PBS_JOBID}.mat')"
