...
MATLAB_COMMAND="mfTest_stoc20GWuc8760dp=RunSimsMultiFidTest(''stoc'',[],''UnitCommit'',[],20, true,[],3,''dp'')"
COMMAND_FOR_FILENAME="RunSimsMultiFidTest_05_20GWuc8760dp"
# >>>>>>>>>>>>>>>>>>>>>>>> End Change block <<<<<<<<<<<<<<<<<<<<<<<<<<
