...
#   ERCOT 2007, existing gens, min 200MW gen, 20% RPS, $80 CO2
#     -- 14wk Full Ops w/ Maintenance 
#     -- 14wk Full Ops WITHOUT Maintenance 
#     -- 14wk Full Ops w/ Maintenance USE Cap limit "helper" 
#     -- 14wk Full Ops w/ Maintenance & Combined Reserves 
#     -- 14wk Full Ops w/ Maintenance 80GW min UC integer (oops)
#
...
# ---  ----------  ----- -------------- ---------------------------------
#   1  2012-08-18  01:20  bpalmintier   Adapted from whenUC_base v2
...
ALL_RUN_OPT=" --sys=thesis_sys.inc --min_gen_size=0.2 --plan_margin=on --rps_penalty=50 "
# Options common to the runs in this file
THIS_FILE_OPT="${ALL_RUN_OPT} --rps=0.2 --co2cost=80 --demand=ercot2007_dem_yr_as_14wk.inc "
...
#======= 14wk Full Ops w/ Maintenance =======
RUN_CODE="whenUC_t5_y14wk_c80_rps20_full_mnt"
...
RUN_OPT=" --maint=1 --skip_cap_limit=1 --plan_margin=0.05 --rsrv=separate --startup=1 --unit_commit=1 --ramp=1 --min_up_down=1 "
...
#======= 14wk Full Ops WITHOUT Maintenance =======
RUN_CODE="whenUC_t5_y14wk_c80_rps20_full"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT=" --skip_cap_limit=1 --plan_margin=0.05 --rsrv=separate --startup=1 --unit_commit=1 --ramp=1 --min_up_down=1 "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
#======= 14wk Full Ops w/ Maintenance USE Cap limit "helper"  =======
RUN_CODE="whenUC_t5_y14wk_c80_rps20_full_mnt_caplim"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT=" --maint=1 --plan_margin=0.05 --rsrv=separate --startup=1 --unit_commit=1 --ramp=1 --min_up_down=1 "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
#======= 14wk Full Ops w/ Maintenance & Combined Reserves =======
RUN_CODE="whenUC_t5_y14wk_c80_rps20_flex_mnt"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT=" --maint=1 --skip_cap_limit=1 --plan_margin=0.05 --rsrv=flex --startup=1 --unit_commit=1 --ramp=1 --min_up_down=1 "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
...
#======= 14wk Full Ops w/ Maintenance 80GW min UC integer (oops) =======
RUN_CODE="whenUC_t5_y14wk_c80_rps20_full_mnt_u80"
...
# Setup run specific OPT
# Note reduced planning margin b/c computing reserves directly
RUN_OPT=" --uc_ignore_unit_min=80 --maint=1 --skip_cap_limit=1 --plan_margin=0.05 --rsrv=separate --startup=1 --unit_commit=1 --ramp=1 --min_up_down=1 "
SHARE_OPT=" ${LONG_OPT} ${THIS_FILE_OPT} "
IO_OPT=" ${COMMON_IO_OPT} -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_v${ADVPOWER_REPO_VER}_${DATE_TIME} "
