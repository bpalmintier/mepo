...
#     -- 20% RPS, $80 CO2, Full UC + Maint, 14wks, 50% scaling
#     -- 20% RPS, $80 CO2, Simple Ops + Maint, 14 wks, 50% scaling
#
...
COMMON_OPT=" --no_nse=1 --sys=ercot2007eGrid_sys.inc --gens=gens_all_new.inc --min_gen_size=0.2 "
...
RUN_CODE="whenUC_y14wk_x05_c80_rps20_full_mnt"
...
RUN_OPT=" --rps=0.2 --co2cost=80 --rsrv=separate --startup=1 --min_up_down=1 --ramp=1 --maint=1 --demand=ercot2007_dem_yr_as_14wk.inc --avail=ercot2007_avail_yr_as_14wk.inc --demscale=0.5"
...
RUN_CODE="whenUC_y14wk_x05_c80_rps20_simp_mnt"
...
# Setup run specific OPT
RUN_OPT=" --rps=0.2 --co2cost=80 --maint=1 --demand=ercot2007_dem_yr_as_14wk.inc --avail=ercot2007_avail_yr_as_14wk.inc --demscale=0.5 "
