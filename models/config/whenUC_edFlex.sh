...
# ---  ----------  ----- -------------- ---------------------------------
#   1  2012-08-30  02:45  bpalmintier   Adapted from whenUC_edRsv.sh v3
#   2  2012-08-31  17:05  bpalmintier   Adjusted run range (-t) to use adj_rsrv_for_nse for 60% & 80% RPS 
...
#   5  2012-09-06  20:27  bpalmintier   Update range to use offline non-UC reserves by default
...
source ${CONFIG_DIR}/whenUC_run.sh `sed -n "${PBS_ARRAYID} s/[,\t]/ /gp" < ${CONFIG_DIR}/whenUC_edFlex_list.csv`
