#!/bin/bash
#
# General MEPO planning run  Grid ARRAY caller with mini-ERCOT system
#   NO ASSUMPTIONS ABOUT ANY SETTINGS including:
...
# ---  ----------  ----- -------------- ---------------------------------
#   1  2015-08-03  03:15  bpalmintier   Adapted from MEPO_plan.sh v1
...
MODEL_DIR_BASE="${HOME}/bryan/advpower/models"
...
#Setup output
OUT_DIR="${HOME}/bryan/advpower/results/gams/miniE/"
...
ALL_RUN_OPT=" --skip_cap_limit=1"
# Options common to the runs in this file
THIS_FILE_OPT="${ALL_RUN_OPT} "

# Note: 244800sec=68hrs
LONG_OPT=" --max_solve_time=244800 "
...
source ${CONFIG_DIR}/MEPO_run.sh `sed -n "${PBS_ARRAYID} s/[, ]/ /gp" < ${CONFIG_DIR}/miniE_plan_list.csv`
