...
COMMON_OPTIONS=" -errmsg=1  -lo=2  -inputdir=${MODEL_DIR} --out_dir=${OUT_DIR} --no_nse=1 --sys=mftest_sys.inc --gens=gens_all_new.inc --rps=0.2 --co2cost=80 --demscale=0.2 --min_gen_size=0.2 --update=../data/wind_rsrv_cap_only_update.inc "
...
RUN_CODE="TX07_yr_x0_2_rps20_rv_c_rmp_st_ud"
...
RUN_CODE="TX07_yr_x0_2_rps20_uclp_rv_c_rmp_st_ud"
