...
#   7  2011-08            bpalmintier   Reworked for RunEnvPolicyScenarios
#   8  2011-09-15  09:14  bpalmintier   Add svn version to output filename
...
COMMAND_FOR_FILENAME="EnvPolicyScenarios_r05_4gw_freeBuild_RsrvOps"
...
MATLAB_COMMAND="RunSaveExit('SpResults_r05_4gw_freeBuild_RsrvOps = RunEnvPolicyScenarios([1:7,12], [], ''OpsLp'', 0.05, 4000, true)','${RESULT_FILE}.mat')"
