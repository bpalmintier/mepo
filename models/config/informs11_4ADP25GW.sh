...
#----------------------------
ID_CODE="25GWadp"
MATLAB_COMMAND="[SpResults${ID_CODE}, SpParams${ID_CODE}, SpValues${ID_CODE}, SpBuild${ID_CODE}, OpsCache${ID_CODE}]=RunSimsFutureLowCO2(1:4,[],''UnitCommit'',[],25000, [], [], [],''adp'',50,1000)"
COMMAND_FOR_FILENAME="RunSimsFutureLowCO2_4_${ID_CODE}"
