...
# ---  ----------  ----- -------------- ---------------------------------
#   1  2012-08-25  01:30  bpalmintier   Adapted from whenUC_edRsv.sh v6
...
#   5  2012-09-05  01:30  bpalmintier   ERGH... remove maintenance (no effect here)
...
source ${CONFIG_DIR}/whenUC_run.sh `sed -n "${PBS_ARRAYID} s/[,	]/ /gp" < ${CONFIG_DIR}/whenUC_uclp_list.csv`
