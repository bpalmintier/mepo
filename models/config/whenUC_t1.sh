...
#     -- 20% RPS, $80 CO2, Full UC + Maint, 14wks
#     -- 20% RPS, $80 CO2, Simple Ops + Maint, 14 wks
#
...
RUN_CODE="whenUC_0_TX07_y14wk_c80_rps20_full_maint"
...
RUN_OPT=" --rps=0.2 --co2cost=80 --rsrv=separate --startup=1 --min_up_down=1 --ramp=1 --maint=1 --demand=ercot2007_dem_yr_as_14wk.inc --avail=ercot2007_avail_yr_as_14wk.inc"
...
RUN_CODE="whenUC_0_TX07_y14wk_c80_rps20_simp_maint"
...
# Setup run specific OPT
RUN_OPT=" --rps=0.2 --co2cost=80 --maint=1 --demand=ercot2007_dem_yr_as_14wk.inc --avail=ercot2007_avail_yr_as_14wk.inc "
