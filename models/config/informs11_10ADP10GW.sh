...
#----------------------------
ID_CODE="10GWadp"
MATLAB_COMMAND="[SpResults${ID_CODE}, SpParams${ID_CODE}, SpValues${ID_CODE}, SpBuild${ID_CODE}, OpsCache${ID_CODE}]=RunSimsFutureLowCO2(1:2,[],''UnitCommit'',[],10000, [], [], [],''adp'',100,1000)"
COMMAND_FOR_FILENAME="RunSimsFutureLowCO2_10_${ID_CODE}"
