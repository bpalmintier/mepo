...
RUN_CODE="TX07_wk_clust_ud_int5_afine_m01"
...
GAMS_OPTIONS="-errmsg=1 -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -lo=2 -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst -inputdir=${MODEL_DIR} --out_dir=${OUT_DIR} --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_run_time_compare_v${ADVPOWER_REPO_VER}_${DATE_TIME}     --no_nse=1 --par_threads=1 --startup=1 --ramp=1 --out_gen_params=1 --max_solve_time=36000 --sys=ercot2007eGrid_sys.inc --gens=ercot2007eGrid_units_clust.inc --demand=ercot2007_dem_wk.inc --min_up_down=1 --uc_int_unit_min=5 --rsrv=separate --mip_gap=0.001 "
...
RUN_CODE="TX07_wk_clust_ud_int20_afine_m01"
...
#
# Plus additional user supplied options pasted into template
GAMS_OPTIONS="-errmsg=1 -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -lo=2 -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst -inputdir=${MODEL_DIR} --out_dir=${OUT_DIR} --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_run_time_compare_v${ADVPOWER_REPO_VER}_${DATE_TIME}     --no_nse=1 --par_threads=1 --startup=1 --ramp=1 --out_gen_params=1 --max_solve_time=36000 --sys=ercot2007eGrid_sys.inc --gens=ercot2007eGrid_units_clust.inc --demand=ercot2007_dem_wk.inc --min_up_down=1 --uc_int_unit_min=20 --rsrv=separate --mip_gap=0.001 "
...
RUN_CODE="TX07_wk_sep_ud_int5_afine_m01"
...
#
# Plus additional user supplied options pasted into template
GAMS_OPTIONS="-errmsg=1 -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -lo=2 -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst -inputdir=${MODEL_DIR} --out_dir=${OUT_DIR} --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_run_time_compare_v${ADVPOWER_REPO_VER}_${DATE_TIME}     --no_nse=1 --par_threads=1 --startup=1 --ramp=1 --out_gen_params=1 --max_solve_time=36000 --sys=ercot2007eGrid_sys.inc --gens=ercot2007eGrid_units_sep.inc --demand=ercot2007_dem_wk.inc --min_up_down=1 --uc_int_unit_min=5 --rsrv=separate --mip_gap=0.001 "
...
RUN_CODE="TX07_wk_sep_ud_int20_afine_m01"
...
#
# Plus additional user supplied options pasted into template
GAMS_OPTIONS="-errmsg=1 -lf=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.log -lo=2 -o=${OUT_DIR}${RUN_CODE}_${GAMS_MODEL}.lst -inputdir=${MODEL_DIR} --out_dir=${OUT_DIR} --out_prefix=${RUN_CODE}_ --memo=${RUN_CODE}_run_time_compare_v${ADVPOWER_REPO_VER}_${DATE_TIME}     --no_nse=1 --par_threads=1 --startup=1 --ramp=1 --out_gen_params=1 --max_solve_time=36000 --sys=ercot2007eGrid_sys.inc --gens=ercot2007eGrid_units_sep.inc --demand=ercot2007_dem_wk.inc --min_up_down=1 --uc_int_unit_min=20 --rsrv=separate --mip_gap=0.001 "
