...
COMMAND_FOR_FILENAME="EnvPolicyScenarios_r05_OpsLp"
MATLAB_COMMAND="RunSaveExit('SpResults = RunEnvPolicyScenarios(1:7, ''../data/EnvPolScen_OpsCache.mat'', ''OpsLp'', 0.05, 2000, true)','${COMMAND_FOR_FILENAME}')"
